    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6  rounded-lg shadow-md bg-gray-700 ">
        ...
        <form action="" >
            ...
            <div>
            <button className=" mt-5 btn btn-outline btn-success">Success</button>
            </div>
            
            <Link className="block mt-2 hover:underline hover:text-blue-500 " >{"Don't"} have an account </Link>
        </form>
      </div>
    </div>
  );
